namespace Dixin.Tests.Linq.Lambda
{
    ...
    public class ChurchTupleTests
    {
        ...
        {
            Tuple<int, string> tuple1 = ChurchTuple<int, string>.Create(1)("a");
            Assert.AreEqual(1, tuple1.Item1());
            Assert.AreEqual("a", tuple1.Item2());
            Tuple<string, int> tuple2 = ChurchTuple<string, int>.Create("a")(1);
            Assert.AreEqual("a", tuple2.Item1());
            Assert.AreEqual(1, tuple2.Item2());
            object @object = new object();
            Tuple<object, int> tuple3 = ChurchTuple<object, int>.Create(@object)(1);
