...
public static class EncodingHelper
{
    ...
    public static string GB2312ToUtf8(this string gb2312Value) => 
        Convert(gb2312Value, Encoding.GetEncoding("gb2312"), Encoding.UTF8);

    public static string Utf8ToGB2312(this string utf8Value) => 
        Convert(utf8Value, Encoding.UTF8, Encoding.GetEncoding("gb2312"));
