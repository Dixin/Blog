...
internal static partial class Video
{
        ...
        PlayWrightWrapper? playWrightWrapper, Lock? @lock = null, bool overwrite = false, bool useCache = false, Action<string>? log = null, CancellationToken cancellationToken = default)
    {
        ...
        const string Companies = nameof(Companies);
        ...
        string companiesFile = Path.Combine(cacheDirectory, $"{imdbId}{Delimiter}{Companies}{ImdbCacheExtension}");
        ...
        string parentCompaniesFile = Path.Combine(cacheDirectory, $"{imdbId}{Delimiter}{Parent}{Delimiter}{Companies}{ImdbCacheExtension}");
        ...
        (
            ...
            useCache ? companiesFile : string.Empty,
            ...
            useCache ? parentCompaniesFile : string.Empty,
        ...
        if (!imdbId.EqualsIgnoreCase(imdbMetadata.ImdbId))
        {
            ...
            companiesFile = Path.Combine(cacheDirectory, $"{imdbMetadata.ImdbId}{Delimiter}{Companies}{ImdbCacheExtension}");
            ...
            parentCompaniesFile = Path.Combine(cacheDirectory, $"{imdbMetadata.ImdbId}{Delimiter}{Parent}{Delimiter}{Companies}{ImdbCacheExtension}");
        ...
        (string Url, string File, string Html)[] files = new (string Url, string File, string Html)[]
            {
                ...
                (companiesUrl, companiesFile, companiesHtml),
                ...
                (parentCompaniesUrl, parentCompaniesFile, parentCompaniesHtml),
