...
internal static partial class Video
{
    ...
    private static readonly string[] SubtitleLanguages = { "bul", "can", "cat", "chs", "cht", "cze", "dan", "dut", "eng", "fil", "fin", "fre", "gre", "heb", "hin", "ind", "ger", "hun", "ita", "jap", "kor", "nor", "pol", "por", "rom", "rum", "rus", "slo", "spa", "swe", "tam", "tha", "ukr" };
