    ...
    string Extension) : IVideoFileInfo, ISimpleParsable<VideoMovieFileInfo>, IDefaultSettings
{
    ...
    private static Regex NameRegex => nameRegex ??= RegexHelper.Create(
        ...
        @"(\.AV1\.10bit\.HDR\.DV|\.AV1\.10bit\.HDR|\.AV1|\.DivX|\.H264|\.x264|\.x265\.10bit\.HDR\.10\+|\.x265\.10bit\.HDR\.DV|\.x265\.10bit\.HDR\.10\+\.DV|\.x265\.10bit\.HDR|\.x265\.10bit|\.x265|\.Xvid)?",
        @"(\.AAC5\.1|\.AAC|\.AC3|\.DD1\.0|\.DD2\.0|\.DD5\.1|\.DD|\.DDP1\.0|\.DDP2\.0|\.DDP5\.1\.Atmos|\.DDP5\.1|\.DDP|\.DTS\-HD\.MA\.1\.0|\.DTS\-HD\.MA\.2\.0|\.DTS\-HD\.MA\.5\.0|\.DTS\-HD\.MA\.5\.1|\.DTS\-HD\.MA\.6\.1|\.DTS\-HD\.MA\.7\.1|\.DTS\-HR\.5\.1|\.DTS\-HR\.7\.1|\.DTS\-X\.7\.1|\.DTS\.5\.1|\.DTS|\.FLAC|\.LPCM|\.LPCM\.1\.0|\.LPCM\.2\.0|\.MP3|\.TrueHD\.2\.0|\.TrueHD\.5\.1|\.TrueHD\.7\.1\.Atmos|\.TrueHD\.7\.1)?",
        @$"(\{Video.VersionSeparator}({Settings.KeywordTopEnglish}|{Settings.KeywordTopForeign}|{Settings.KeywordPreferredOld}|\[{Settings.KeywordPreferredNew}\.(AG|AM|BZ|LT|ME|MX)\]|[a-zA-Z0-9@]+?))?",
        @"(\.[0-9]+Audio)?",
        @"(\.watermark)?",
