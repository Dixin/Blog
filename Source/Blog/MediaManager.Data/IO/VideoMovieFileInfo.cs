        ...
        nameRegex ??= new Regex(
            string.Join(
                ...
                [
                    ...
                    @$"(\.AV1|\.AV1\.10bit\.HDR|\.AV1\.10bit\.HDR\.DV|\.DivX|\.H264|\.x264|\.x265|\.x265\.10bit|\.x265\.10bit\.HDR|\.x265\.10bit\.HDR\.10\+|\.x265\.10bit\.HDR\.DV|\.Xvid)?",
                    @$"(\.AAC|\.AAC5\.1|\.AC3|\.DD|\.DD5\.1|\.DDP|\.DDP1\.0|\.DDP2\.0|\.DDP5\.1|\.DDP5\.1\.Atmos|\.DTS|\.DTS\-HD\.MA\.1\.0|\.DTS\-HD\.MA\.2\.0|\.DTS\-HD\.MA\.5\.0|\.DTS\-HD\.MA\.5\.1|\.DTS\-HD\.MA\.6\.1|\.DTS\-HD\.MA\.7\.1|\.DTS\-HR\.5\.1|\.DTS\-HR\.7\.1|\.DTS\-X\.7\.1|\.DTS\.5\.1|\.LPCM\.1\.0|\.LPCM\.2\.0|\.MP3|\.TrueHD\.2\.0|\.TrueHD\.5\.1|\.TrueHD\.7\.1|\.TrueHD\.7\.1\.Atmos)?",
