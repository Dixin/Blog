...
namespace Tutorial.Tests.LinqToObjects
{
    ...
    {
        public static void AssertGroupingCorrect<TKey, TElement>(IEnumerable<TKey> keys, IEnumerable<TElement> elements, IEnumerable<System.Linq.IGrouping<TKey, TElement>> grouping)
        {
            AssertGroupingCorrect<TKey, TElement>(keys, elements, grouping, EqualityComparer<TKey>.Default);
        }
        public static void AssertGroupingCorrect<TKey, TElement>(IEnumerable<TKey> keys, IEnumerable<TElement> elements, IEnumerable<System.Linq.IGrouping<TKey, TElement>> grouping, IEqualityComparer<TKey> keyComparer)
        {
            if (grouping == null)
            {
            ...
            foreach (System.Linq.IGrouping<TKey, TElement> group in grouping)
            {
        ...
        {
            IEnumerable<System.Linq.IGrouping<bool, int>> oddsEvens = new int[] { 1, 2, 3, 4 }.GroupBy(i => i % 2 == 0);
        ...
        public void Grouping_ICollection_Contains()
        {
            ...
            ICollection<int> odds = e.Current.ToList();
            ...
            ICollection<int> evens = e.Current.ToList();
        ...
        public void DuplicateKeysCustomComparer()
        {
            ...
            IEnumerable<long> expected = System.Linq.Enumerable.GroupBy(source, e => e.Name, e => e.Score, (k, es) => (long)(k ?? " ").Length * es.Sum(), new AnagramEqualityComparer());
        ...
        public void NullComparer()
        {
            ...
            IEnumerable<long> expected = System.Linq.Enumerable.GroupBy(source, e => e.Name, e => e.Score, (k, es) => (long)(k ?? " ").Length * es.Sum(), null);
        ...
        public void GroupingToArray()
        {
            ...
            System.Linq.IGrouping<string, Record>[] groupedArray = source.GroupBy(r => r.Name).ToArray();
        ...
        public void GroupingWithElementSelectorToArray()
        {
            ...
            System.Linq.IGrouping<string, int>[] groupedArray = source.GroupBy(r => r.Name, e => e.Score).ToArray();
            Assert.Equal(4, groupedArray.Length);
        ...
        public void GroupingToList()
        {
            ...
            List<System.Linq.IGrouping<string, Record>> groupedList = source.GroupBy(r => r.Name).ToList();
        ...
        public void GroupingWithElementSelectorToList()
        {
            ...
            List<System.Linq.IGrouping<string, int>> groupedList = source.GroupBy(r => r.Name, e => e.Score).ToList();
            Assert.Equal(4, groupedList.Count);
